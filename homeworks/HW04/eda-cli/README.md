...
### 5. `POST /quality-flags-from-csv` – флаги качества из HW03

Эндпоинт принимает CSV-файл и возвращает **только флаги качества**, включая те, что были добавлены в HW03:
- `has_constant_columns`
- `has_high_cardinality_categoricals`
- и другие пользовательские эвристики.
